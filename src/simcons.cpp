...
// =============================================================================
SimCons::SimCons(const YAML::Node& doc): SimParam(doc),
...
// =============================================================================
void SimCons::mutualLocModeImpl(
...
// =============================================================================
SimConsOrig::SimConsOrig(const YAML::Node& doc): SimParam(doc),
  mode2_rate1(doc["mode2_rate1"].as<double>()),
  mode2_rate2(doc["mode2_rate2"].as<double>()),
  mode2_rateQ(doc["mode2_rateQ"].as<double>())
{}

// =============================================================================
void SimConsOrig::mutualLocModeImpl(
  const VectorXd& z, const std::pair<int,int>& edge,
  const MatrixXd& H1, const MatrixXd& H2, const MatrixXd& Q,
  const VectorXd& z_diff)
{
